...
--
-- **間隔は2分。** 1分刻みで測った冷め方は 1分 96ms / 2分 263ms / 3分 553ms /
-- 5分 554ms で、**3分でもう5分と変わらない**。ここを5分にしていたのは
-- 「日中は使っている本人の操作が温め続けるので要らない」と考えたからだが、
-- **それは外れだった**——オーナーが昼にスマホから開いて3秒以上かかっている。
-- 使っている**あいだ**は温かいが、**開く瞬間はいつも使っていない**。
-- 朝だけを1分毎にしたのは、朝しか測っていなかったからで、朝しか開かないからではない。
